...
use app\models\b2b2c\search\VipOperationLogSearch;
...
/**
 * VipOperationLogController implements the CRUD actions for VipOperationLog model.
 */
class VipOperationLogController extends BaseAuthController
{
    /**
     * @inheritdoc
     */
