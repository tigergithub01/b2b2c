...
use app\models\b2b2c\search\MerchantCommentSearch;
...
/**
 * MerchantCommentController implements the CRUD actions for ProductComment model.
 */
class MerchantCommentController extends BaseAuthController
{
    /**
     * @inheritdoc
     */
