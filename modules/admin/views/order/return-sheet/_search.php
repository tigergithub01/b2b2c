...
/* @var $model app\models\b2b2c\search\ReturnSheetSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="return-sheet-search">
    ...
    <?= $form->field($model, 'return_apply_id') ?>

    <?= $form->field($model, 'code') ?>

    <?= $form->field($model, 'order_id') ?>

    <?php // echo $form->field($model, 'out_id') ?>
    ...
    <?php // echo $form->field($model, 'organization_id') ?>
	    ...
	    <div class="box-footer clearfix form-group search_box">
	    	...
	    	<?= Html::a(Yii::t('app', 'Create Return Sheet'), ['create'], ['class' => 'btn btn-success']) ?>
	    </div>
