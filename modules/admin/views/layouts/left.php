                ...
                'items' => [
                	...
                	['label' => '会员管理', 'icon' => 'fa fa-table','url' => '#',
                			'items' => [
                					...
                					['label' => '会员日志',  'url' => ['vip/vip-operation-log/index','sort'=>'-op_date'],'icon' => 'fa fa-circle-o',],
                	...
                	['label' => '订单管理', 'icon' => 'fa fa-table','url' => '#',
                			'items' => [
                					...
                					// ['label' => '发货单', 'url' => ['order/out-stock-sheet/index'],'icon' => 'fa fa-circle-o',],
                			],
                	],
...
//                 					['label' => '角色信息', 'url' => ['system/sys-role/index'],'icon' => 'fa fa-circle-o',],
                					['label' => '系统日志', 'url' => ['system/sys-operation-log/index','sort'=>'-op_date'],'icon' => 'fa fa-circle-o',],
                					['label' => '系统配置', 'url' => ['system/sys-config/index'],'icon' => 'fa fa-circle-o',],
