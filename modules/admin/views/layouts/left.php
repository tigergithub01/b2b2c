                ...
                'items' => [
                	...
                	['label' => '会员管理', 'icon' => 'fa fa-table','url' => '#',
                			'items' => [
                					...
                					['label' => '会员日志',  'url' => ['vip/product-comment/index'],'icon' => 'fa fa-circle-o',],
                			],
                	],
                	['label' => '商户管理', 'icon' => 'fa fa-table','url' => '#',
                			'items' => [
                					...
                					['label' => '商户日志',  'url' => ['vip/vip-org-case/index'],'icon' => 'fa fa-circle-o',],
                			],
                	],
                	['label' => '论坛管理', 'icon' => 'fa fa-table','url' => '#',
                		'items' => [
                				['label' => '帖子列表',  'url' => ['vip/merchant/index'],'icon' => 'fa fa-circle-o'],
                				['label' => '帖子评价',  'url' => ['vip/vip-org-case/index'],'icon' => 'fa fa-circle-o',],
                		],
                	],
...
//                 					['label' => '模块信息', 'url' => ['system/sys-module/index'],'icon' => 'fa fa-circle-o',],
                					...
                					['label' => '文章管理', 'url' => ['system/modify-pwd/index'],'icon' => 'fa fa-circle-o',],
                			],
       				 ],
                ],
            ]
