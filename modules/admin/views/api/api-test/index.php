	...
	<div class="box box-primary">
		...
		<div class="box-body">
			...
			<div class="form-group">
				...
				<?php echo Html::button('支付调用请求',['id'=>'btn_order_pay_req','class' => 'btn btn-primary','url'=>Url::to(['/vip/api/member/order/so-sheet/pay-req'])]);?>
				...
				<?php echo Html::button('退款申请',['id'=>'btn_refund_apply_create','class' => 'btn btn-primary','url'=>Url::to(['/vip/api/member/order/refund-sheet-apply/create'])]);?>
				<?php echo Html::button('订单权限',['id'=>'btn_order_auth','class' => 'btn btn-primary','url'=>Url::to(['/vip/api/member/order/so-sheet/auth'])]);?>
			</div>
			
			<div class="form-group">
				<?php echo Html::button('退款申请单列表',['id'=>'btn_refund_apply_list','class' => 'btn btn-primary','url'=>Url::to(['/vip/api/member/order/refund-sheet-apply/index'])]);?>
				<?php echo Html::button('退款申请单详情',['id'=>'btn_refund_apply_view','class' => 'btn btn-primary','url'=>Url::to(['/vip/api/member/order/refund-sheet-apply/view'])]);?>
			</div>
