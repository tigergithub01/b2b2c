...
<div class="quotation-form">
    ...
    <?= $form->field($model, 'merchant_id')->dropDownList(\yii\helpers\ArrayHelper::map($merchantList, "id", "vip_name"), ['prompt' => Yii::t('app', 'select_prompt')]) ?>
	    ...
	    <div class="box-footer form-group">
	        ...
	        <?php  if ($model->isNewRecord) {echo Html::submitButton(Yii::t('app', '提交'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']);}?>
	        
	        <?php // echo if (!($model->isNewRecord)) {echo Html::a('添加订单明细',['create-quotation-detail', 'quotation_id'=>$model->id],['class' => 'btn btn-success']);}?>
	    </div>
