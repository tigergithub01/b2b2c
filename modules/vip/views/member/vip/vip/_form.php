...
<div class="vip-form">
    ...
    <?= $form->field($model, 'vip_name')->textInput(['maxlength' => true])->label('昵称') ?>
    ...
    <?php // echo $form->field($model, 'vip_type_id')->dropDownList(\yii\helpers\ArrayHelper::map($vipTypeList, "id", "name"), ['prompt' => Yii::t('app', 'select_prompt')]) ?>
